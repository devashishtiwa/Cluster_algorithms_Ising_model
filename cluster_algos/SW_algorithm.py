...
def SW_algorithm(params, xy_coordinates, spin_numbers, spins):
    
    """
    This function identifies all the possible cluster, and put that in a array named
    cluster_island. 

    Returns:
        cluster island: containsing all the clusters, 
